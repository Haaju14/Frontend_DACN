...
//   const [rooms, setRooms] = useState<KhocHocData[]>([]);
//   const [currentPage, setCurrentPage] = useState<number>(1);
//   const [total, setTotal] = useState<number>(0);
//   const [isModalVisible, setIsModalVisible] = useState<boolean>(false);
//   const [currentRoom, setCurrentRoom] = useState<KhocHocData>({
//   });
...
//   const showModal = (room?: KhocHocData) => {
//     setCurrentRoom(
//       room || {
...
//     mutationFn: (data: { KhocHocData: object; id: string }) =>
//       KhoaHocAPI(data.KhocHocData, data.id),
//     onSuccess: (data) => {
//       if (file && data) {
//         mutationRoomImage.mutate({ image: file, id: data.content.id });
//       }
